...
const app: Application = express();
const httpServer = createServer(app); // Vercel ignores this for deployment, but keeps it for local use
...
// **--- THE FIX ---**
// Change the default export to the Express app instance (app)
export default app;
