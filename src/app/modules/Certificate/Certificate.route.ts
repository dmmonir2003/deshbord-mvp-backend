...
import {  createCertificateValidationSchema, updateCertificateValidationSchema } from './Certificate.validation';
...
router.post(
  ...
  validateRequest(createCertificateValidationSchema),
...
router.post(
  ...
  CertificateControllers.shareCertificate
);
router.post(
  '/:id/unshare',
  auth(USER_ROLE.superAdmin, USER_ROLE.primeAdmin),
  CertificateControllers.unShareCertificate
);
